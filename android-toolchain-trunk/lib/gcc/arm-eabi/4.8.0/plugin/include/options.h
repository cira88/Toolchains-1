...
enum opt_code
{
  ...
  OPT_fuse_ld_bfd = 966,                     /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 967,                    /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 968,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 969,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 970,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 971,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 972,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 973, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 974,                /* -fvect-cost-model */
  OPT_fverbose_asm = 975,                    /* -fverbose-asm */
  /* OPT_fversion = 976, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 977,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 978,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 979,                    /* -fvisibility= */
  OPT_fvpt = 980,                            /* -fvpt */
  /* OPT_fvtable_gc = 981, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 982, */            /* -fvtable-thunks */
  OPT_fweak = 983,                           /* -fweak */
  OPT_fweb = 984,                            /* -fweb */
  OPT_fwhole_file = 985,                     /* -fwhole-file */
  OPT_fwhole_program = 986,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 987,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 988,              /* -fworking-directory */
  OPT_fwpa = 989,                            /* -fwpa */
  OPT_fwrapv = 990,                          /* -fwrapv */
  /* OPT_fxref = 991, */                     /* -fxref */
  /* OPT_fzee = 992, */                      /* -fzee */
  OPT_fzero_initialized_in_bss = 993,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 994,                      /* -fzero-link */
  OPT_g = 995,                               /* -g */
  OPT_gant = 996,                            /* -gant */
  OPT_gcoff = 997,                           /* -gcoff */
  OPT_gdwarf_ = 998,                         /* -gdwarf- */
  OPT_gen_decls = 999,                       /* -gen-decls */
  OPT_ggdb = 1000,                           /* -ggdb */
  OPT_gnat = 1001,                           /* -gnat */
  OPT_gnatO = 1002,                          /* -gnatO */
  OPT_gno_pubnames = 1003,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1004,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1005,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1006,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1007,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1008,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1009,                   /* -gsplit-dwarf */
  OPT_gstabs = 1010,                         /* -gstabs */
  OPT_gstabs_ = 1011,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1012,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1013,                        /* -gtoggle */
  OPT_gvms = 1014,                           /* -gvms */
  OPT_gxcoff = 1015,                         /* -gxcoff */
  OPT_gxcoff_ = 1016,                        /* -gxcoff+ */
  OPT_h = 1017,                              /* -h */
  OPT_idirafter = 1018,                      /* -idirafter */
  OPT_imacros = 1019,                        /* -imacros */
  OPT_imultiarch = 1020,                     /* -imultiarch */
  OPT_imultilib = 1021,                      /* -imultilib */
  OPT_include = 1022,                        /* -include */
  OPT_iplugindir_ = 1023,                    /* -iplugindir= */
  OPT_iprefix = 1024,                        /* -iprefix */
  OPT_iquote = 1025,                         /* -iquote */
  OPT_isysroot = 1026,                       /* -isysroot */
  OPT_isystem = 1027,                        /* -isystem */
  OPT_iwithprefix = 1028,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1029,              /* -iwithprefixbefore */
  OPT_k8 = 1030,                             /* -k8 */
  OPT_l = 1031,                              /* -l */
  OPT_lang_asm = 1032,                       /* -lang-asm */
  OPT_mabi_ = 1033,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1034,             /* -mabort-on-noreturn */
  OPT_mapcs = 1035,                          /* -mapcs */
  OPT_mapcs_float = 1036,                    /* -mapcs-float */
  OPT_mapcs_frame = 1037,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1038,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1039,              /* -mapcs-stack-check */
  OPT_march_ = 1040,                         /* -march= */
  OPT_marm = 1041,                           /* -marm */
  OPT_mbig_endian = 1042,                    /* -mbig-endian */
  OPT_mcallee_super_interworking = 1043,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1044,     /* -mcaller-super-interworking */
  OPT_mcpu_ = 1045,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1046,            /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 1047,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1048,                  /* -mfp16-format= */
  OPT_mfpu_ = 1049,                          /* -mfpu= */
  /* OPT_mhard_float = 1050, */              /* -mhard-float */
  OPT_mlittle_endian = 1051,                 /* -mlittle-endian */
  OPT_mlong_calls = 1052,                    /* -mlong-calls */
  OPT_mpic_register_ = 1053,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1054,            /* -mpoke-function-name */
  OPT_msched_prolog = 1055,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1056,               /* -msingle-pic-base */
  /* OPT_msoft_float = 1057, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1058,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1059,                         /* -mthumb */
  OPT_mthumb_interwork = 1060,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1061,                  /* -mtls-dialect= */
  OPT_mtp_ = 1062,                           /* -mtp= */
  OPT_mtpcs_frame = 1063,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1064,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1065,                         /* -mtune= */
  OPT_munaligned_access = 1066,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1067,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1068,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1069,              /* -mword-relocations */
  OPT_mwords_little_endian = 1070,           /* -mwords-little-endian */
  OPT_n = 1071,                              /* -n */
  OPT_no_canonical_prefixes = 1072,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1073,              /* -no-integrated-cpp */
  ...
  OPT_pie = 1086,                            /* -pie */
  OPT_pipe = 1087,                           /* -pipe */
  OPT_print_file_name_ = 1088,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1089,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1090,          /* -print-multi-directory */
  OPT_print_multi_lib = 1091,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1092,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1093,                /* -print-multiarch */
  ...
  OPT_time = 1153,                           /* -time */
  OPT_time_ = 1154,                          /* -time= */
  OPT_traditional = 1155,                    /* -traditional */
  OPT_traditional_cpp = 1156,                /* -traditional-cpp */
  OPT_trigraphs = 1157,                      /* -trigraphs */
  OPT_u = 1158,                              /* -u */
  OPT_undef = 1159,                          /* -undef */
  OPT_v = 1160,                              /* -v */
  OPT_version = 1161,                        /* -version */
  OPT_w = 1162,                              /* -w */
  OPT_wrapper = 1163,                        /* -wrapper */
  OPT_x = 1164,                              /* -x */
  OPT_z = 1165,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
