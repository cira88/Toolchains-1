...
enum opt_code
{
  ...
  OPT_mandroid = 1035,                       /* -mandroid */
  OPT_mapcs = 1036,                          /* -mapcs */
  OPT_mapcs_float = 1037,                    /* -mapcs-float */
  OPT_mapcs_frame = 1038,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1039,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1040,              /* -mapcs-stack-check */
  ...
  OPT_mfpu_ = 1051,                          /* -mfpu= */
  OPT_mglibc = 1052,                         /* -mglibc */
  /* OPT_mhard_float = 1053, */              /* -mhard-float */
  OPT_mlittle_endian = 1054,                 /* -mlittle-endian */
  OPT_mlong_calls = 1055,                    /* -mlong-calls */
  OPT_mpic_register_ = 1056,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1057,            /* -mpoke-function-name */
  OPT_msched_prolog = 1058,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1059,               /* -msingle-pic-base */
  /* OPT_msoft_float = 1060, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1061,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1062,                         /* -mthumb */
  OPT_mthumb_interwork = 1063,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1064,                  /* -mtls-dialect= */
  OPT_mtp_ = 1065,                           /* -mtp= */
  OPT_mtpcs_frame = 1066,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1067,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1068,                         /* -mtune= */
  OPT_muclibc = 1069,                        /* -muclibc */
  ...
  OPT_profile = 1104,                        /* -profile */
  OPT_pthread = 1105,                        /* -pthread */
  OPT_quiet = 1106,                          /* -quiet */
  OPT_r = 1107,                              /* -r */
  OPT_rdynamic = 1108,                       /* -rdynamic */
  ...
  OPT_time = 1161,                           /* -time */
  OPT_time_ = 1162,                          /* -time= */
  OPT_tno_android_cc = 1163,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1164,                 /* -tno-android-ld */
